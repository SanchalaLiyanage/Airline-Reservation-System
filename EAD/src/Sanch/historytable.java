...
public class historytable extends JPanel{
    ...
    public historytable( String USERID) {
        ...
        UPDATE.setBorder(BorderFactory.createEmptyBorder(10, 50, 10, 50));
        DELETE.setBorder(BorderFactory.createEmptyBorder(10, 50, 10, 50));
        BACK.setBorder(BorderFactory.createEmptyBorder(10, 50, 10, 50));
