...
//add panel
        ...
        JLabel titleLabel = new JLabel("<html><center><br><br><br>Login as a User</center></html>");
...
//add panel to frame
        ...
        loginButton.addActionListener(e -> {
            ...
            if (username == null || username.isEmpty() || password == null || password.isEmpty()) {
                ...
                try {
                    String state[] =  new DbQuerys().checkLogin(username, password);
                    String state1 = state[0];
                    String state2 = state[1];

                    if (state1.equals("succes")) {
